...
DEF SEVII_LANDMARK EQU const_value
	const LANDMARK_ONE_ISLAND        ; 5f
	const LANDMARK_TREASURE_BEACH    ; 60
	const LANDMARK_KINDLE_ROAD       ; 61
	const LANDMARK_MT_EMBER          ; 62
	const LANDMARK_TWO_ISLAND        ; 63
	const LANDMARK_CAPE_BRINK        ; 64
	const LANDMARK_THREE_ISLAND      ; 65
	const LANDMARK_THREE_ISLE_PATH   ; 66
	const LANDMARK_THREE_ISLE_PORT   ; 67
	const LANDMARK_BOND_BRIDGE       ; 68
	const LANDMARK_BERRY_FOREST      ; 69
	const LANDMARK_FOUR_ISLAND       ; 70
	const LANDMARK_ICEFALL_CAVE      ; 71
	const LANDMARK_FIVE_ISLAND       ; 72
	const LANDMARK_WATER_LABYRINTH   ; 73
	const LANDMARK_RESORT_GORGEOUS   ; 74
	const LANDMARK_LOST_CAVE         ; 75
	const LANDMARK_FIVE_ISLE_MEADOW  ; 76
	const LANDMARK_ROCKET_WAREHOUSE  ; 77
	const LANDMARK_MEMORIAL_PILLAR   ; 78
	const LANDMARK_SIX_ISLAND        ; 79
	const LANDMARK_WATER_PATH        ; 7a
	const LANDMARK_GREEN_PATH        ; 7b
	const LANDMARK_PATTERN_BUSH      ; 7c
	const LANDMARK_OUTCAST_ISLAND    ; 7d
	const LANDMARK_ALTERING_CAVE     ; 7e
	const LANDMARK_RUIN_VALLEY       ; 7f
	const LANDMARK_DOTTED_HOLE       ; 80
	const LANDMARK_SEVEN_ISLAND      ; 81
	const LANDMARK_TRAINER_TOWER     ; 82
	const LANDMARK_CANYON_ENTRANCE   ; 83
	const LANDMARK_SEVAULT_CANYON    ; 84
	const LANDMARK_TANOBY_KEY        ; 85
	const LANDMARK_TANOBY_RUINS      ; 86
	const LANDMARK_TANOBY_CHAMBERS   ; 87
