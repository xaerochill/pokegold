...
; Johto Gym Leader TM gifts
	const_skip ; EVENT_GOT_TM31_MUD_SLAP
	const_skip ; EVENT_GOT_TM49_FURY_CUTTER
	const_skip ; EVENT_GOT_TM01_DYNAMICPUNCH
	const_skip ; EVENT_GOT_TM45_ATTRACT
	const_skip ; EVENT_GOT_TM30_SHADOW_BALL
	const_skip ; EVENT_GOT_TM23_IRON_TAIL
	const_skip ; EVENT_GOT_TM16_ICY_WIND
	const_skip ; EVENT_GOT_TM24_DRAGONBREATH
; HMs (EVENT_GOT_HM07_WATERFALL is with the Johto itemballs)
	const_skip ; EVENT_GOT_HM01_CUT
	const_skip ; EVENT_GOT_HM02_FLY
	const_skip ; EVENT_GOT_HM03_SURF
	const_skip ; EVENT_GOT_HM04_STRENGTH
	const_skip ; EVENT_GOT_HM05_FLASH
	const_skip ; EVENT_GOT_HM06_WHIRLPOOL
	const_skip ; unused
; Rods
...
; Johto story events
	...
	const_skip ; EVENT_GOT_TM13_SNORE_FROM_MOOMOO_FARM
	...
	const_skip ; EVENT_GOT_TM02_HEADBUTT
	...
	const_skip ; EVENT_GOT_TM47_STEEL_WING
	const_skip ; EVENT_GOT_TM37_SANDSTORM
	...
	const_skip ; EVENT_GOT_TM12_SWEET_SCENT
...
; Kanto story events
	...
	const EVENT_TALKED_TO_CINNABAR_GYM_GUIDE_ONCE
	...
	const EVENT_SWITCH_IN_POKEMON_MANSION ; EVENT_GOT_TM03_CURSE
	const EVENT_GOT_CLEANSE_TAG
	const EVENT_POKEMON_MANSION_1F_ESCAPE_ROPE ; EVENT_GOT_TM19_GIGA_DRAIN
	const EVENT_POKEMON_MANSION_1F_CARBOS ; EVENT_GOT_TM06_TOXIC
	const EVENT_GOT_UP_GRADE
	const EVENT_GAVE_SCIENTIST_OLD_AMBER ; EVENT_GOT_TM07_ZAP_CANNON
	const EVENT_GAVE_SCIENTIST_DOME_FOSSIL ; EVENT_GOT_TM42_DREAM_EATER
	const EVENT_TALKED_TO_OAK_IN_KANTO
	const EVENT_GOT_HP_UP_FROM_VERMILION_GUY
	const EVENT_GAVE_SCIENTIST_HELIX_FOSSIL ; EVENT_GOT_TM29_PSYCHIC
; Kanto hidden items
	...
	const EVENT_POKEMON_MANSION_1F_HIDDEN_MOON_STONE
	const EVENT_POKEMON_MANSION_3F_HIDDEN_MAX_REVIVE
	const EVENT_POKEMON_MANSION_B1F_HIDDEN_RARE_CANDY
; Unused: next 342 events
...
; Burglar
	...
	const EVENT_BEAT_BURGLAR_DUSTY
	const EVENT_BEAT_BURGLAR_JENSEN
	const EVENT_BEAT_BURGLAR_LOUIS
	const EVENT_BEAT_BURGLAR_JAC
; Biker
...
; Scientist
	...
	const EVENT_BEAT_SCIENTIST_KEATON
	const EVENT_BEAT_SCIENTIST_CONNOR
	const EVENT_BEAT_SCIENTIST_LEOPOLD
	const EVENT_BEAT_SCIENTIST_TRACE
	const EVENT_BEAT_SCIENTIST_BEAU
	const EVENT_BEAT_SCIENTIST_TAYLOR
	const EVENT_BEAT_SCIENTIST_CORY
	const EVENT_BEAT_SCIENTIST_ELTON
	const EVENT_BEAT_SCIENTIST_TRAVIS
	const EVENT_BEAT_SCIENTIST_MELVIN
	const EVENT_BEAT_SCIENTIST_BRAYDON
	const EVENT_BEAT_SCIENTIST_CRAIG
	const EVENT_BEAT_SCIENTIST_GIDEON
...
; Johto itemballs
	...
	const_skip ; EVENT_GOT_HM07_WATERFALL
...
; Kanto people
	...
	const EVENT_CINNABAR_GYM_GYM_GUIDE
