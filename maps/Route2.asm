...
Route2_MapEvents:
	...
	warp_event 13,  9, DIGLETTS_CAVE, 3
	...
	bg_event 14, 24, BGEVENT_ITEM, Route2HiddenMaxEther
	bg_event  8, 14, BGEVENT_ITEM, Route2HiddenFullHeal
	bg_event 12, 44, BGEVENT_ITEM, Route2HiddenFullRestore
	bg_event 13, 62, BGEVENT_ITEM, Route2HiddenRevive
	...
	object_event  3, 44, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_RIGHT, 1, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 5, TrainerBugCatcherDoug, -1
	object_event 15, 32, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2DireHit, EVENT_ROUTE_2_DIRE_HIT
	object_event 18, 29, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2MaxPotion, EVENT_ROUTE_2_MAX_POTION
	...
	object_event  3, 12, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route2FruitTree, -1
