...
Route13_MapEvents:
	...
	def_bg_events
	bg_event 33,  5, BGEVENT_READ, Route13TrainerTips
	bg_event 31, 11, BGEVENT_READ, Route13Sign
	bg_event 15, 13, BGEVENT_READ, Route13DirectionsSign
	bg_event  1, 13, BGEVENT_ITEM, Route13HiddenCalcium
	...
	object_event 23, 10, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 5, TrainerPokefanmJoshua, -1
	object_event  7, 13, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerHikerKenny, -1
	object_event 12,  4, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerPokefanmAlex, -1
