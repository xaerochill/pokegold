...
VermilionCity_MapEvents:
	...
	warp_event 18, 30, VERMILION_PORT_PASSAGE, 1
	warp_event 19, 30, VERMILION_PORT_PASSAGE, 2
	...
	bg_event 37, 13, BGEVENT_READ, VermilionCityDiglettsCaveSign
	...
	bg_event 14, 18, BGEVENT_ITEM, VermilionCityHiddenFullHeal
	...
	object_event 21, 13, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, VermilionGymBadgeGuy, -1
