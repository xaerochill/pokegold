...
if DEF(_DEBUG)
	...
	loadmem wPartyMon1Moves+3, ROCK_SLIDE
	loadmem wPartyMon2Moves+0, FIRE_BLAST
	loadmem wPartyMon2Moves+1, SUNNY_DAY
	loadmem wPartyMon2Moves+2, SOLARBEAM
	loadmem wPartyMon2Moves+3, IRON_TAIL
	loadmem wPartyMon3Moves+0, FLY
	loadmem wPartyMon3Moves+1, SURF
	loadmem wPartyMon3Moves+2, HEADBUTT
	loadmem wPartyMon3Moves+3, FLASH
	loadmem wPartyMon4Moves+0, STRENGTH
	loadmem wPartyMon4Moves+1, ROCK_SMASH
	loadmem wPartyMon4Moves+2, CUT
	loadmem wPartyMon4Moves+3, WATERFALL
	loadmem wPartyMon5Moves+0, EARTHQUAKE
	loadmem wPartyMon5Moves+1, ROCK_SLIDE
	loadmem wPartyMon5Moves+2, SWORDS_DANCE
	loadmem wPartyMon5Moves+3, BODY_SLAM
	; intro events
