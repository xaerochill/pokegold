...
# by https://github.com/dannye/crystal-tracker
# usage for a whole folder:   python3 upgrade.py -v audio/music/
# usage for individual files: python3 upgrade.py -v audio/drumkits.asm
