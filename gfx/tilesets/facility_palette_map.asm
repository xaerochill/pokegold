	...
	tilepal 0, ROOF, ROOF, GRAY, WATER, WATER, WATER, RED, ROOF
	tilepal 0, BROWN, BROWN, BROWN, BROWN, GREEN, GREEN, BROWN, BROWN
	tilepal 0, ROOF, ROOF, GRAY, GRAY, RED, RED, GRAY, ROOF
	tilepal 0, RED, RED, BROWN, BROWN, GREEN, GREEN, BROWN, BROWN
	tilepal 0, BROWN, BROWN, BROWN, GRAY, GRAY, GRAY, BROWN, WATER
