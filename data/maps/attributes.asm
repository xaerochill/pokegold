...
;    (x offset for east/west, y offset for north/south)
	...
	if _NARG == 6
		...
		if "\1" === "north"
			if MAP_CONNECTIONS_{CURRENT_MAP_ID} & (NORTH | SOUTH)
				fail "Invalid order for 'connection' (must be north)"
			endc
			...
			if MAP_CONNECTIONS_{CURRENT_MAP_ID} & (SOUTH)
				fail "Invalid order for 'connection' (must be north)"
			endc
			...
			if MAP_CONNECTIONS_{CURRENT_MAP_ID} & (WEST)
				fail "Invalid order for 'connection' (must be north)"
			endc
...
ENDM
	...
	map_attributes SilverCaveOutside, SILVER_CAVE_OUTSIDE, $69
	...
	map_attributes Route28, ROUTE_28, $69
...
; FORTUNE_ISLAND
	...
	map_attributes PatternBush, PATTERN_BUSH, $00
	map_attributes AlteringCave, ALTERING_CAVE, $09
	map_attributes DottedHole, DOTTED_HOLE, $09

; QUEST_ISLAND
	map_attributes SevenIsland, SEVEN_ISLAND, $3D
	connection north, TrainerTower, TRAINER_TOWER, -1
	connection south, CanyonEntrance, CANYON_ENTRANCE, 0

	map_attributes TrainerTower, TRAINER_TOWER, $3D
	connection south, SevenIsland, SEVEN_ISLAND, 0

	map_attributes CanyonEntrance, CANYON_ENTRANCE, $3D
	connection north, SevenIsland, SEVEN_ISLAND, 1
	connection east, SevaultCanyon, SEVAULT_CANYON, 9

	map_attributes SevaultCanyon, SEVAULT_CANYON, $69
	connection south, TanobyRuins, TANOBY_RUINS, -23
	connection west, CanyonEntrance, CANYON_ENTRANCE, -9

	map_attributes TanobyRuins, TANOBY_RUINS, $3D
	connection north, SevaultCanyon, SEVAULT_CANYON, 23

	map_attributes TanobyKey, TANOBY_KEY, $09
	map_attributes TanobyChambers, TANOBY_CHAMBERS, $00

	map_attributes Route23, ROUTE_23, $5d
	...
	map_attributes EcruteakTinTowerBackEntrance, ECRUTEAK_TIN_TOWER_BACK_ENTRANCE, $00
	...
	map_attributes CinnabarGym, CINNABAR_GYM, $00
	map_attributes CinnabarPokemonLabHallway, CINNABAR_POKEMON_LAB_HALLWAY, $00
	map_attributes CinnabarPokemonLabTradeRoom, CINNABAR_POKEMON_LAB_TRADE_ROOM, $00
	map_attributes CinnabarPokemonLabMetronomeRoom, CINNABAR_POKEMON_LAB_METRONOME_ROOM, $00
	map_attributes CinnabarPokemonLabFossilRoom, CINNABAR_POKEMON_LAB_FOSSIL_ROOM, $00
	...
	map_attributes VermilionFishingSpeechHouse, VERMILION_FISHING_SPEECH_HOUSE, $00
	...
	map_attributes VermilionMagnetTrainSpeechHouse, VERMILION_MAGNET_TRAIN_SPEECH_HOUSE, $00
	map_attributes VermilionMart, VERMILION_MART, $00
	map_attributes VermilionDiglettsCaveSpeechHouse, VERMILION_DIGLETTS_CAVE_SPEECH_HOUSE, $00
	...
	map_attributes PewterMuseumOfScience1F, PEWTER_MUSEUM_OF_SCIENCE_1F, $00
	map_attributes PewterMuseumOfScience2F, PEWTER_MUSEUM_OF_SCIENCE_2F, $00
	map_attributes OlivinePort, OLIVINE_PORT, $0a
	map_attributes VermilionPort, VERMILION_PORT, $00
