...
; entries correspond to map groups
	...
	db PREDEFPAL_FUCHSIA ; KNOT_ISLAND
	db PREDEFPAL_FUCHSIA ; BOON_ISLAND
	db PREDEFPAL_FUCHSIA ; KIN_ISLAND
	db PREDEFPAL_FUCHSIA ; FLOE_ISLAND
	db PREDEFPAL_FUCHSIA ; CHRONO_ISLAND
	db PREDEFPAL_FUCHSIA ; FORTUNE_ISLAND
	db PREDEFPAL_FUCHSIA ; QUEST_ISLAND
