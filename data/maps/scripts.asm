...
INCLUDE "maps/CinnabarPokemonLabHallway.asm"
INCLUDE "maps/CinnabarPokemonLabTradeRoom.asm"
INCLUDE "maps/CinnabarPokemonLabMetronomeRoom.asm"
INCLUDE "maps/CinnabarPokemonLabFossilRoom.asm"
