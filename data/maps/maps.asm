...
MapGroup_Cinnabar:
	...
	map CinnabarPokemonLabRoom1, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarPokemonLabRoom2, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarPokemonLabRoom3, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
