...
MapGroup_Dungeons:
	...
	map SafariZoneFuchsiaGateBeta, TILESET_MUSEUM, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map Route19FuchsiaGate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarGym, TILESET_UNDERGROUND, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
	...
	map CinnabarPokemonLabHallway, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarPokemonLabTradeRoom, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarPokemonLabMetronomeRoom, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CinnabarPokemonLabFossilRoom, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map PokemonMansionB1F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion1F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion2F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion3F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_Pewter:
	...
	map PewterMuseumOfScience1F, TILESET_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map PewterMuseumOfScience2F, TILESET_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Fuchsia:
	...
	map Route15FuchsiaGate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map Route8SaffronGate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_8, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map Route16Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_16, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route7SaffronGate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_7, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route17Route18Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_17, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map Route5SaffronGate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_KnotIsland:
	...
	map TreasureBeach, TILESET_SEVII, ROUTE, LANDMARK_TREASURE_BEACH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map KindleRoad, TILESET_SEVII, ROUTE, LANDMARK_KINDLE_ROAD, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MtEmber, TILESET_SEVII, ROUTE, LANDMARK_MT_EMBER, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map MtEmberInterior, TILESET_CAVE, ROUTE, LANDMARK_MT_EMBER, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map EmberSpa, TILESET_CAVE, ROUTE, LANDMARK_MT_EMBER, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_BoonIsland:
	...
	map CapeBrink, TILESET_SEVII, ROUTE, LANDMARK_CAPE_BRINK, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_KinIsland:
	...
	map ThreeIslePath, TILESET_CAVE, ROUTE, LANDMARK_THREE_ISLE_PATH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ThreeIslePort, TILESET_SEVII, ROUTE, LANDMARK_THREE_ISLE_PORT, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BondBridge, TILESET_SEVII, ROUTE, LANDMARK_BOND_BRIDGE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BerryForest, TILESET_FOREST, CAVE, LANDMARK_BERRY_FOREST, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	assert_table_length NUM_KIN_ISLAND_MAPS

MapGroup_FloeIsland:
	table_width MAP_LENGTH
	map FourIsland, TILESET_SEVII, TOWN, LANDMARK_FOUR_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map IcefallCaveEntrance, TILESET_ICE_PATH, CAVE, LANDMARK_ICEFALL_CAVE, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map IcefallCave1F, TILESET_ICE_PATH, CAVE, LANDMARK_ICEFALL_CAVE, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map IcefallCaveB1F, TILESET_ICE_PATH, CAVE, LANDMARK_ICEFALL_CAVE, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map IcefallCaveBack, TILESET_ICE_PATH, CAVE, LANDMARK_ICEFALL_CAVE, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	assert_table_length NUM_FLOE_ISLAND_MAPS

MapGroup_ChronoIsland:
	table_width MAP_LENGTH
	map FiveIsland, TILESET_SEVII, TOWN, LANDMARK_FIVE_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map WaterLabyrinth, TILESET_SEVII, ROUTE, LANDMARK_WATER_LABYRINTH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ResortGorgeous, TILESET_SEVII, ROUTE, LANDMARK_RESORT_GORGEOUS, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map LostCave, TILESET_CAVE, CAVE, LANDMARK_LOST_CAVE, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map FiveIsleMeadow, TILESET_SEVII, ROUTE, LANDMARK_FIVE_ISLE_MEADOW, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map MemorialPillar, TILESET_SEVII, ROUTE, LANDMARK_MEMORIAL_PILLAR, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_CHRONO_ISLAND_MAPS

MapGroup_FortuneIsland:
	table_width MAP_LENGTH
	map SixIsland, TILESET_SEVII, TOWN, LANDMARK_SIX_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map WaterPathNorth, TILESET_SEVII, ROUTE, LANDMARK_WATER_PATH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map WaterPathSouth, TILESET_SEVII, ROUTE, LANDMARK_WATER_PATH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map GreenPath, TILESET_SEVII, ROUTE, LANDMARK_GREEN_PATH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PatternBush, TILESET_FOREST, CAVE, LANDMARK_PATTERN_BUSH, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map OutcastIsland, TILESET_SEVII, ROUTE, LANDMARK_OUTCAST_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AlteringCave, TILESET_CAVE, ROUTE, LANDMARK_ALTERING_CAVE, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RuinValley, TILESET_SEVII, ROUTE, LANDMARK_RUIN_VALLEY, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map DottedHole, TILESET_CAVE, ROUTE, LANDMARK_DOTTED_HOLE, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_FORTUNE_ISLAND_MAPS

MapGroup_QuestIsland:
	table_width MAP_LENGTH
	map SevenIsland, TILESET_SEVII, ROUTE, LANDMARK_SEVEN_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TrainerTower, TILESET_SEVII, ROUTE, LANDMARK_TRAINER_TOWER, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CanyonEntrance, TILESET_SEVII, ROUTE, LANDMARK_CANYON_ENTRANCE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SevaultCanyon, TILESET_SEVII, ROUTE, LANDMARK_SEVAULT_CANYON, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TanobyKey, TILESET_CAVE, ROUTE, LANDMARK_TANOBY_KEY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TanobyRuins, TILESET_SEVII, ROUTE, LANDMARK_TANOBY_RUINS, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TanobyChambers, TILESET_RUINS_OF_ALPH, ROUTE, LANDMARK_TANOBY_CHAMBERS, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
