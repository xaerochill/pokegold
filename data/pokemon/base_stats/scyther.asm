...
ENDC
	...
	; tm/hm learnset
	tmhm ATTRACT, COUNTER, CURSE, CUT, DETECT, DOUBLE_EDGE, DOUBLE_TEAM, ENDURE, FALSE_SWIPE, FRUSTRATION, FURY_CUTTER, HEADBUTT, HIDDEN_POWER, HYPER_BEAM, LIGHT_SCREEN, MIMIC, PROTECT, RAIN_DANCE, RAZOR_WIND, REST, RETURN, ROCK_SMASH, SAFEGUARD, SKULL_BASH, SLEEP_TALK, SNORE, STEEL_WING, SUBSTITUTE, SUNNY_DAY, SWAGGER, SWIFT, SWORDS_DANCE, TAKE_DOWN, THIEF, TOXIC
	; end
