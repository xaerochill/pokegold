...
ENDC
	...
	; tm/hm learnset
	tmhm ANCIENTPOWER, ATTRACT, CURSE, DETECT, DOUBLE_EDGE, DOUBLE_TEAM, DREAM_EATER, ENDURE, FLASH, FRUSTRATION, GIGA_DRAIN, HEADBUTT, HIDDEN_POWER, LEECH_LIFE, MIMIC, PROTECT, PSYCHIC_M, PSYCH_UP, REST, RETURN, SHADOW_BALL, SLEEP_TALK, SNORE, SOLARBEAM, STEEL_WING, SUBSTITUTE, SUNNY_DAY, SWAGGER, SWEET_SCENT, SWIFT, SWORDS_DANCE, TAKE_DOWN, THIEF, TOXIC, WHIRLWIND
	; end
