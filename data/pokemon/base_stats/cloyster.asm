...
ENDC
	...
	; tm/hm learnset
	tmhm ATTRACT, BLIZZARD, BODY_SLAM, BUBBLEBEAM, CURSE, DOUBLE_EDGE, DOUBLE_TEAM, ENDURE, EXPLOSION, FRUSTRATION, HEADBUTT, HIDDEN_POWER, HYPER_BEAM, ICE_BEAM, ICY_WIND, LIGHT_SCREEN, MIMIC, PROTECT, RAIN_DANCE, REFLECT, REST, RETURN, SELFDESTRUCT, SLEEP_TALK, SNORE, SPIKES, SUBSTITUTE, SURF, SWAGGER, SWIFT, TAKE_DOWN, TELEPORT, TOXIC, TRI_ATTACK, WHIRLPOOL
	; end
