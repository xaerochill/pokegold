...
ENDC
	...
	; tm/hm learnset
	tmhm ATTRACT, BLIZZARD, BODY_SLAM, BUBBLEBEAM, CURSE, DETECT, DIG, DOUBLE_EDGE, DOUBLE_TEAM, ENDURE, FRUSTRATION, HEADBUTT, HEAL_BELL, HIDDEN_POWER, HYPER_BEAM, ICE_BEAM, ICY_WIND, IRON_TAIL, MIMIC, MUD_SLAP, PAY_DAY, PROTECT, RAIN_DANCE, REFLECT, REST, RETURN, ROAR, ROCK_SMASH, SHADOW_BALL, SKULL_BASH, SLEEP_TALK, SNORE, STRENGTH, SUBSTITUTE, SUNNY_DAY, SURF, SWAGGER, SWIFT, TAKE_DOWN, TOXIC, WATERFALL, WHIRLPOOL
	; end
